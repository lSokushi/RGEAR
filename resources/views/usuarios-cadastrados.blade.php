...
<section class="col-md-10 bg-light hide" class="listUsers">
        <div class="p-4 container-fluid">
          <h1 class="mb-4 text-dark w-100">Usuários Cadastrados</h1>
            ...
            <table class="table">
              ...
              <tbody>
                <tr class="table-group-divider">
                  <th scope="row">1</th>
                  <td>João Pedro de Almeida Moraes</td>
                  <td>joao.pedro@example.com</td>
                  <td>4002-8922</td>
                  <td>122.334.556-78</td>
                  ...
                  <td><button type="button" class="btn btn-danger w-auto" data-bs-toggle="modal"
                      data-bs-target="#deleteUserModal" id="delete"><i class="bi bi-trash3-fill fs-3"></i></button></td>
                </tr>
                <tr>
                  <th scope="row">2</th>
                  <td>Marcio Luis Valença Araújo</td>
                  <td>marcio@example.com</td>
                  <td>4002-8922</td>
                  <td>122.334.556-78</td>
                  <td><button type="button" class="btn btn-warning w-auto" id="edit"><i
                        class="bi bi-pencil-square fs-3"></i></button></td>
                ...
                <tr>
                  <th scope="row">3</th>
                  <td>Andrique Figueirêdo Amorim</td>
                  <td>andrique.fiqueiredo@example.com</td>
                  <td>4002-8922</td>
                  <td>122.334.556-78</td>
                  <td><button type="button" class="btn btn-warning w-auto" id="edit"><i
                        class="bi bi-pencil-square fs-3"></i></button></td>
