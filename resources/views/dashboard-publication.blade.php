            ...
            <div class="bg-white p-4 shadow-sm rounded">
              <form action="{{ route('dashboard-publication.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  ...
                  <input class="form-control form-control-lg p-3 h-auto fs-3" type="file" id="formFileMultiple"
                    accept="image/png,image/webp,image/jpg,image/jpeg" multiple name="images[]">
                </div>
                <div class="col-md-6">
                ...
                <div class="d-flex justify-content-end">
                  <div class="col-md-2">
                    ...
                    <input type="number" class="form-control fs-3" id="inputYear4" placeholder="2024" step="1"
                      name="year" />
                  </div>
