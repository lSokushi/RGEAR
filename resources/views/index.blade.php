<x-main-layout title="RGEAR">
    ...
    <main>
        ...
        <section class="hero">
            <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" aria-label="Carrossel Principal">
                <div class="carousel-inner">
                    @foreach ([['title' => 'Inovação e Educação com Impacto', 'text' => 'O RGEAR é um centro de excelência em engenharia, inteligência artificial e robótica.', 'image' => '/img/carrousel/slide1.jpg', 'link' => '#sobre', 'btn_text' => 'Saiba Mais'], ['title' => 'Tecnologia para o Futuro', 'text' => 'Conectamos tecnologia à educação para transformar ideias em soluções.', 'image' => '/img/carrousel/slide2.jpg', 'link' => '#projetos', 'btn_text' => 'Nossos Projetos'], ['title' => 'Impacto Social e Sustentável', 'text' => 'Promovemos inovação sustentável para comunidades e estudantes.', 'image' => '/img/carrousel/slide3.jpg', 'link' => '#estatisticas', 'btn_text' => 'Ver Estatísticas']] as $index => $slide)
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        ...
                        <p class="about-text text-secondary">
                            ...
                            Robótica
                            Aplicadas – nasceu no âmbito do Projeto Robótica Educacional IFBA Lauro de Freitas.
                        </p>
                        <div class="row gy-4">
        ...
        <!-- 6. Seção de Artigos em Destaque -->
        <section class="articles py-5" id="artigos">
            ...
            <!-- 8. Seção de Eventos em Destaque -->
    ...
    <!-- 9. Scripts -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js" integrity="sha384-xyz"
        crossorigin="anonymous" defer></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Splide/3.6.12/splide.min.js" integrity="sha384-xyz"
        crossorigin="anonymous" defer></script>
