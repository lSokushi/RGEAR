                        ...
                        <div class="bg-white p-4 shadow-sm rounded">
                            <form class="row g-5">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control h-75 fs-3" id="inputName4"
                                        placeholder="Maria Santana" />
                                </div>
                                <div class="col-md-6">
                                    <label for="inputCPF4" class="form-label fs-3">CPF</label>
                                    <input type="text" class="form-control h-75 fs-3" id="inputCPF4"
                                        placeholder="123.456.789-12" />
                                </div>

                                <div class="col-md-6">
                                    <label for="inputTel" class="form-label fs-3">Telefone</label>
                                    <input type="tel" class="form-control h-75 fs-3" id="inputTel"
                                        placeholder="55 5555-5555" />
                                </div>
                                <div class="col-md-6">
                                    <label for="inputEmail" class="form-label fs-3">E-mail</label>
                                    <input type="email" class="form-control h-75 fs-3" id="inputEmail"
                                    ...
                                    <fieldset class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="userType"
                                                id="userType1" value="supervisor" checked />
                                ...
                                <div class="col-md-3">
                                    <fieldset class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="researchLine"
                                                id="researchLine1" value="automation" checked />
                                            <label class="form-check-label fs-3" for="researchLine1">Automação e
                                                Robótica Educacional</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="researchLine"
                                                id="researchLine2" value="engineering" />
                                            <label class="form-check-label fs-3" for="researchLine2">Engenharia e IA
                                                Aplicada</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="researchLine"
                                                id="researchLine3" value="computing" />
                                            <label class="form-check-label fs-3" for="researchLine3">Computação,
                                                Educação e
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="password" class="form-control p-3 fs-3" id="inputPassword"
                                        placeholder="Ex: 1234" />
                                ...
                                <div class="col-12 text-end">
                                    <button type="submit"
                                        class="border-0 rounded text-light fs-3 shadow p-3">Cadastrar</button>
                                </div>
                            </form>
                        </div>
                    </div>
